...
//	this
  ...
  answerTemplate() {
	  debugger;
    return html`
	<span class="answer" @click=${this._answered(this)} idx="0"><p class="answer-title">a1</p></span>
	<span class="answer" @click=${this._answered(this)} idx="1"><p class="answer-title">a2</p></span>
	`;
  }
  ...
  render() {
	...
	window.document.questionJSON = JSON.parse(this.jsondata); 
